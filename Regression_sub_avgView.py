...
df = pd.read_csv("C:/Users/user/Desktop/Term_project/ds_remove0.csv")
...
for category in df["category"].unique():
    ...
    if len(df_category) >= 5:  
        ...
        coef_dict[category] = 0  # use 0 for categories with too few data points
...
results.to_csv("C:/Users/user/Desktop/Term_project/new_ds_remove0.csv", index=False)